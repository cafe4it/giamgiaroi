(function () {
  ...
  module.exports = function () {
    ...
    this.Given(/^Tôi là người dùng$/, function () {
      // no callbacks! DDP has been promisified so you can just return it
      return this.server.call('reset'); // this.ddp is a connection to the mirror
    });

    this.When(/^Tôi chuyển đến "([^"]*)"$/, function (relativePath, callback) {
    ...
    this.Then(/^Tôi sẽ nhìn thấy tiêu đề là "([^"]*)"$/, function (expectedTitle, callback) {
